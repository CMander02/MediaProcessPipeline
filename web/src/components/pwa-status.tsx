...
export function PwaStatus() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-[calc(4.75rem+env(safe-area-inset-bottom))] z-[100] mx-auto flex max-w-md items-center justify-between gap-3 rounded-lg border bg-popover px-3 py-2 text-sm text-popover-foreground shadow-lg md:bottom-4">
